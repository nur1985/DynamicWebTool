...
#$MINERvA_screen = "Global Monitor Browser";
$MINERvA_screen = "root";
$MINERvA_screenshot = $IMAGE_DIR."GMBrowser.png";
$MINERvA_time = $IMAGE_DIR."gmbrowser_time.txt";
...
# Run the script by doing perl web_screenshot_gmbrowser.pl
#
