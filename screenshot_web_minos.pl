...
#$MINERvA_screen = "MINOS+ Run Control GUI : MINERvA at ROC-West (1-630-840-2060) RMS NEARDET";
$MINERvA_screen = "root";
$MINERvA_screenshot = $IMAGE_DIR."MINOS_run_control.png";
$MINERvA_time = $IMAGE_DIR."minos_time.txt";
...
# Run the script by doing perl web_screenshot_minos.pl
#
